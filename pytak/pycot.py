...
class Link(gexml.Model):
    ...
    type = gexml.fields.String(required=False)
...
class Color(gexml.Model):
    """CoT Detail"""
    class meta:  # NOQA pylint: disable=invalid-name,missing-class-docstring,too-few-public-methods
        tagname = 'color'
    argb = gexml.fields.Float(required =False)

class Usericon(gexml.Model):
    """CoT Detail"""
    class meta:  # NOQA pylint: disable=invalid-name,missing-class-docstring,too-few-public-methods
        tagname = 'usericon'
    iconsetpath = gexml.fields.String(required =False)
...
class Detail(gexml.Model):
    ...
    color = gexml.fields.Model(Color, required = False)
    usericon = gexml.fields.Model(Usericon, required=False)
